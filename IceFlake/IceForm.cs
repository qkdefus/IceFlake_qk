...
namespace IceFlake
{
    public partial class IceForm : Form, ILog
    {
        ...
        private void IceForm_Load(object sender, EventArgs e)
        {
            ...
            // shutdown injector.bat
            try
            {
                var proc = System.Diagnostics.Process.GetProcessesByName("Cmd");
                if (proc[0].Id != null)
                {
                    proc[0].Kill();
                }
        ...
        private void buttonDebug_Click(object sender, EventArgs e)
        {
            ...
            //    if (Direct3D.ViewPortMaxZ > 0.950f)
            //        Direct3D.ViewPortMaxZ = 0.939f;

            //    Direct3D.ViewPortMaxZ = Direct3D.ViewPortMaxZ + 0.0001f;
            //    Log.WriteLine("ViewPortMaxZ " + Direct3D.ViewPortMaxZ);
